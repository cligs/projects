...
wdir = "/home/christof/Dropbox/0-Analysen/2015/hybrid/rf740e/" # end with slash.
...
outfolder = wdir+"7_aggregates/POL/"
targets = ["subgenre", "author-name", "subsubgenre","decade", "narration", "setting", "author-gender", "title", "protagonist-policier", "segmentID"] 
...
outfolder = wdir + "8_visuals/wordles/"
left = 250 # image start at the left
upper = 50 # image start at the top
right = 2200 # image end on the right
lower = 1450 # image end at the bottom
...
targetCategories = ["title", "author-name", "year", "subgenre"]
topTopicsShown = 16 
numOfTopics = numOfTopics 
fontscale = 1.0
...
averageDatasets = wdir+"7_aggregates/avg*.csv" 
firstWordsFile = wdir+"7_aggregates/firstWords.csv"
outfolder = wdir+"8_visuals/distinctiveness/v2_"
targetCategories = ["ssbgenre"] 
mode = "minusmean" #minusmean|divbymean|divbyrowmean|zscores|absolute
...
topics = ["65"] # list of one or several topics
...
averageDatasets = wdir+"7_aggregates/POL/avg*.csv" 
figsize = (10,6) # width,height
outfolder = wdir+"8_visuals/POL/clustering/v2_"
topicsPerItem = "mid120" # can be set
