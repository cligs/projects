...
wdir = "/home/Documents/tm/" # end with slash.
### Path to the TreeTagger file (language-dependent!)
tagger = "/home/Programs/TreeTagger/cmd/tree-tagger-spanish"
### Path to Mallet installation directory
mallet_path = "/home/Programs/Mallet/bin/mallet"
### Path to the font for wordle generation
font_path = "/home/.fonts/AlegreyaSans-Regular.otf"
...
substitutionsFile = wdir+"extras/es_pretokenize_subs.csv"
...
mode = "esN" # frN=nouns, esN=nouns, frNV=nouns+verbs, frNVAA=nouns+verbs+adj+adverbs 
stoplist_errors = wdir+"extras/es_stopwords_errors.txt" # in tmw folder
...
stoplist_project = wdir+"extras/es_stopwords_project.txt" # in tmw folder
...
outfolder = wdir+"7_aggregates/"
targets = ["author-name", "author-gender", "author-country", "author-continent", "title", "setting", "decade", "subgenre", "narrator", "protagonist-gender", "binID"]  
...
targetCategories = ["author-name", "author-gender", "author-country", "author-continent", "title", "setting", "decade", "subgenre", "narrator", "protagonist-gender", "binID"]
topTopicsShown = 30 
numOfTopics = numOfTopics 
fontscale = 1.0
